...
| `/one-line-generator/:documentId` | `OneLineGeneratorDetail` | toolId: `one-line-generator`   | Edit spec, live preview, download `.drawio` / `.svg` / `.pdf`                                                          |
