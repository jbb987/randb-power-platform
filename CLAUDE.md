...
| `/todo-list`                      | `TodoListTool`              | all                            | Collaborative to-do list — My Work / Team / Week views + Present mode (collection `user-tasks`)                        |
