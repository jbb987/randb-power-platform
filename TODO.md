...
- [ ] **Deploy the activity trigger**: `firebase deploy --only functions:onUserTaskWrite`. Note: CLI reauth done under jb@randbpowerinc.us (old @randbpowersolutions.com token had expired). (source: conversation 2026-06-12)
