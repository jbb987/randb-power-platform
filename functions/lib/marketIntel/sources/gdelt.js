...
async function fetchGdelt(timespan) {
    const query = `${config_1.GDELT_TOPIC_QUERY} sourcecountry:US sourcelang:english`;
    ...
    try {
        ...
        v2_1.logger.warn(`fetchGdelt: non-JSON response — ${raw.slice(0, 200)}`);
        return [];
    }
