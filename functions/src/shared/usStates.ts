...
const STATE_NAME_LOWER_TO_USPS: Record<string, string> = Object.fromEntries(
  Object.entries(STATE_NAME_TO_USPS).map(([name, abbr]) => [name.toLowerCase(), abbr]),
);
 ...
 */
export function firstStateMentioned(lowerText: string): string | undefined {
